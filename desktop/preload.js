...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  loginServer: (serverId) => ipcRenderer.invoke('login-server', serverId),
  getServerSession: (serverId) => ipcRenderer.invoke('get-server-session', serverId),
  clearServerSession: (serverId) => ipcRenderer.invoke('clear-server-session', serverId),
